...
2. In order to create the cartesian_product for a given **plan_order_id** in the **cartesian_product.py** file replace the **plan_order_id** in the **payload** variable.
...
For the sample of API's response, refer to the json files in the repository.
